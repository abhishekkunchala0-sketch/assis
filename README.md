...
Edit `config.yaml` to set your LLM preferences:

```yaml
llm:
  provider: "huggingface"  # ollama, openai, openrouter, huggingface
...
```bash
# For HuggingFace Inference API (free tier available)
